...
namespace Sage200Microservice.API.Controllers
{
    ...
    public sealed class SalesReceiptsController : ControllerBase
    {
        ...
        /// <summary>
        /// POST /api/SalesReceipts — Creates a Sales Receipt (POST /sales_receipts).
        /// </summary>
        [HttpPost]
        ...
        public async Task<IActionResult> CreateAsync([FromBody] SalesReceiptCreate body, CancellationToken ct)
        {
            ...
            // Service call (no EF transaction)
            ...
            // Persist ExternalRefs -> URN links (execution strategy + local transaction)
