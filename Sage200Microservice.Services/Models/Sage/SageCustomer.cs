...
namespace Sage200Microservice.Services.Models.Sage
{
    ...
    /// Represents the 'customer' schema from sales.json for Sage API interactions.
    /// Includes Contacts collection. Adds non-serialized Email property for convenience.
    /// </summary>
    public class SageCustomer
    {
        ...
        public decimal? Balance { get; set; } // ReadOnly
        ...
        public long? CountryCodeId { get; set; }// Top-level country code ID
        ...
        [MaxLength(60)][JsonPropertyName("analysis_code_2")] public string? AnalysisCode2 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_3")] public string? AnalysisCode3 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_4")] public string? AnalysisCode4 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_5")] public string? AnalysisCode5 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_6")] public string? AnalysisCode6 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_7")] public string? AnalysisCode7 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_8")] public string? AnalysisCode8 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_9")] public string? AnalysisCode9 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_10")] public string? AnalysisCode10 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_11")] public string? AnalysisCode11 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_12")] public string? AnalysisCode12 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_13")] public string? AnalysisCode13 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_14")] public string? AnalysisCode14 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_15")] public string? AnalysisCode15 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_16")] public string? AnalysisCode16 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_17")] public string? AnalysisCode17 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_18")] public string? AnalysisCode18 { get; set; }
        [MaxLength(60)][JsonPropertyName("analysis_code_19")] public string? AnalysisCode19 { get; set; }
        ...
        [MaxLength(100)][JsonPropertyName("spare_text_2")] public string? SpareText2 { get; set; }
        [MaxLength(100)][JsonPropertyName("spare_text_3")] public string? SpareText3 { get; set; }
        [MaxLength(100)][JsonPropertyName("spare_text_4")] public string? SpareText4 { get; set; }
        [MaxLength(100)][JsonPropertyName("spare_text_5")] public string? SpareText5 { get; set; }
        [MaxLength(100)][JsonPropertyName("spare_text_6")] public string? SpareText6 { get; set; }
        [MaxLength(100)][JsonPropertyName("spare_text_7")] public string? SpareText7 { get; set; }
        [MaxLength(100)][JsonPropertyName("spare_text_8")] public string? SpareText8 { get; set; }
        [MaxLength(100)][JsonPropertyName("spare_text_9")] public string? SpareText9 { get; set; }
        ...
        public SageAddress? MainAddress { get; set; }

        // [NEW] Added Contacts collection based on schema
        [JsonPropertyName("contacts")]
        public List<SageCustomerContact>? Contacts { get; set; }
        ...
        // Convenience property, not serialized/deserialized directly
        // Populated by helper method after deserialization
        [JsonIgnore]
        public string? Email { get; set; }

        // Note: ReadOnly complex properties like currency, country_code etc. omitted for brevity
        // Add them if needed for GET operations, marked appropriately.
    }
}
